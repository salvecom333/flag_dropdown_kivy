...
couldn't find anything, came close to some other solutions but it just worked with one image, if i wanted multiple images to be on a dropdown of buttons or labels i had to figure that out! This code works! This code is just an example, if you want to add more countries modify!
